...
export default function App() {
  ...
  return (
    <div id="pos-root" className="min-h-screen bg-slate-100 text-slate-800 flex flex-col font-sans select-none overflow-hidden">
      ...
      <header className="h-auto md:h-16 bg-white border-b border-slate-200 flex flex-col md:flex-row md:items-center justify-between px-4 md:px-6 py-3 md:py-0 gap-3 md:gap-0 shadow-sm flex-shrink-0 z-10">
        <div className="flex items-center justify-between md:justify-start gap-2 md:gap-3 w-full md:w-auto">
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div className="w-8 h-8 md:w-10 md:h-10 bg-emerald-600 rounded-lg flex items-center justify-center text-white font-bold text-lg md:text-xl shadow-md flex-shrink-0">
              +
            </div>
            <div>
              <h1 className="text-base md:text-2xl font-extrabold tracking-tight text-blue-900 leading-tight">
                Farmacias <span className="text-emerald-600">San Matías</span>
              </h1>
            </div>
          </div>
          {/* Estatus de Conexión en Móvil */}
          <div className="flex md:hidden items-center space-x-2">
            <span className="px-2 py-0.5 bg-blue-50 text-blue-700 rounded-full text-[9px] font-black flex items-center gap-1 border border-blue-100">
        ...
        <div className="flex items-center justify-between md:justify-end gap-1.5 md:gap-4 w-full md:w-auto text-sm">
          {/* Teclas rápidas informativas (solo escritorio) */}
          ...
          {/* Estatus de Conexión (Escritorio) */}
          ...
          {/* Información del cajero (solo escritorio) */}
          <div className="hidden md:flex items-center space-x-3 border-l border-slate-200 pl-4 mr-2">
          ...
          {/* Botonera de acciones (distribuida de forma equitativa en móviles para que no se corte) */}
          <div className="flex items-center gap-1.5 md:gap-3 w-full md:w-auto">
            {/* Botón Historial de Ventas */}
            <button 
              onClick={() => setShowHistoryModal(true)}
              className="flex-1 md:flex-none bg-slate-50 hover:bg-slate-100 text-slate-600 border border-slate-200 py-2 md:p-2.5 rounded-xl transition-all cursor-pointer relative shadow-sm flex items-center justify-center gap-1 text-[10px] md:text-xs font-black uppercase"
              title="Ver Historial de Ventas"
            >
              <History className="w-3.5 h-3.5 md:w-4 md:h-4 text-emerald-600" />
            ...
            <button 
              ...
              className="flex-1 md:flex-none bg-slate-700 hover:bg-slate-800 text-white font-extrabold text-[10px] md:text-xs py-2 md:py-2.5 px-1.5 md:px-4 rounded-xl transition-all cursor-pointer flex items-center justify-center gap-1 md:gap-2 shadow-md hover:shadow-lg"
            ...
            <button 
              ...
              className="flex-1 md:flex-none bg-blue-900 hover:bg-blue-950 text-white font-extrabold text-[10px] md:text-xs py-2 md:py-2.5 px-1.5 md:px-4 rounded-xl transition-all cursor-pointer flex items-center justify-center gap-1 md:gap-2 shadow-md hover:shadow-lg"
            ...
            <button 
              ...
              className="flex-1 md:flex-none bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold text-[10px] md:text-xs py-2 md:py-2.5 px-1.5 md:px-4 rounded-xl transition-all cursor-pointer flex items-center justify-center gap-1 md:gap-2 shadow-md hover:shadow-lg"
      ...
      <main className="flex-1 flex flex-col md:flex-row overflow-hidden relative">
        ...
        <section id="right-products" className="w-full md:w-[60%] p-4 md:p-6 flex flex-col gap-4 md:gap-6 bg-slate-100 h-full overflow-hidden">
